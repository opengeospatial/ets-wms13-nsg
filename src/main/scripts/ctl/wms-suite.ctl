...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl" 
  ...
  <ctl:suite name="tns:ets-${ets-code}-${version}">
    <ctl:title>NSG DGIWG WMS 1.3.0 Conformance Test Suite</ctl:title>
    <ctl:description>Checks DGIWG WMS 1.3.0 implementations for conformance to DGIWG WMS 1.3.0. for NSG</ctl:description>
    ...
    <ctl:code>
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          <h2>NSG DGIWG WMS 1.3.0 Conformance Test Suite</h2>
