...
public class BoundingBox {
    ...
    /**
     * @param crs
     *            of the bounding box, never <code>null</code>
     * @param minX
     *            the min x value, must be a value less than maxX
     * @param minY
     *            the min y value, must be a value less than maxY
     * @param maxX
     *            the max x value, must be a value greater than minX
     * @param maxY
