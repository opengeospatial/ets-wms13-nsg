...
public class LayerInfo {
    ...
    /**
     * @param layerName
     *            name of the layer (wms:Layer/wms:Name), never <code>null</code> or empty
     * @param isQueryable
     *            <code>true</code> if the layer is queryable (wms:Layer/@queryable=1), <code>false</code> if the layer
     *            is not queryable (wms:Layer/@queryable=1)
     * @param bboxes
     *            bounding boxes of the layer (wms:Layer/wms:wms:BoundingBox), never <code>null</code>
     * @param dimensions
    ...
    /**
     * @return the name of the layer (wms:Layer/wms:Name), never <code>null</code>
     */
    ...
    /**
     * @return the bounding boxes of the layer (wms:Layer/wms:wms:BoundingBox), never <code>null</code>
     */
    ...
    /**
     * @return the dimensions of the layer (wms:Layer/wms:wms:Dimension), never <code>null</code>
     */
