...
/**
 * A W3C SOAP message consumer that converts an input stream to a {@link SOAPMessage} object. It is suitable for reading
 * SOAP 1.2 entities (media type "application/soap+xml").
 * 
 * @see <a href="http://tools.ietf.org/html/rfc3902" target="_blank">RFC 3902: The "application/soap+xml" media type</a>
 */
